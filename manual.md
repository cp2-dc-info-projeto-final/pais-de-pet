...
**Lista das Funcionalidades:**
 ...
 - [Adicionar Produtos ao Orçamento](#Adicionar-Produtos-ao-Orçamento)
...
A funcionalidade de edição de perfil permite que o usuário atualize suas informações pessoais, como nome, e-mail e telefone. Essa área também possibilita ajustar preferências de uso e garantir que dados essenciais estejam sempre atualizados para facilitar compras e agendamentos. O processo de edição é simples e rápido, garantindo total autonomia ao usuário.
